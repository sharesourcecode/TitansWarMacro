...
# /wait
	...
	while [[ -z $EXIT ]] ; do
		...
		echo -e "$URL\n 💤	...\n$ACCESS"
		SRC=$(w3m -debug -dump_source -o accept_encoding=='*;q=0' $URL/altars/?close=reward -o user_agent="$(shuf -n1 .ua)")
		SRC=$(w3m -debug -dump_source -o accept_encoding=='*;q=0' $URL/altars/enterFight -o user_agent="$(shuf -n1 .ua)")
...
# /view
	w3m -debug -o accept_encoding=='*;q=0' $URL/altars -o user_agent="$(shuf -n1 .ua)" | head -n15 | tail -n14 | sed "/\[user\]/d;/\[arrow\]/d;/\ \[/d"
	echo "Altars (✔)"
