...
*Faço atualizações e correções periodicas, caso queira manter os scripts atualizados em seu dispositivo execute as instruções acima a partir da segunda etapa.* 
